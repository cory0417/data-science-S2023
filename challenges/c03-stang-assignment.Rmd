...
- How many aluminum alloys are in this dataset? How do you know?
  - There is only one alloy in the dataset. There is only `al_24st` as a distinct value.
...
- It's tempting to say that `E` and `mu` decreases as thickness increases. However, the relationship from the plot seems monotone and varying according to the angle and the thickness.

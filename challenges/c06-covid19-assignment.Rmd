...
- I took the mean of the cases and deaths per 100k of each counties and compared them to the mean of all the cases and deaths in the US. 
- Both the top 10 means for cases and deaths are much greater than the mean of all the counties. 
- Trousdale has a particularly high mean cases per 100k even compared to other means cases in the top 10. 
- Population size is smaller than 30,000 for all counties in top 10 for both mean deaths and cases except McKinley. 
...
- Small counties with less than 1000 in population size have slightly lower mean cases per 100k and deaths per 100k than the mean of those for the US. 
...
df_normalized %>%
  filter(state == "Massachusetts", !is.na(fips)) %>%
  ggplot(
    aes(
      date,
      cases_per100k,

...
"gam" trend is similar to the "lm" trend up to `carat` 2.5 but significantly diverges afterwards.
...
`hwy` mileage tends to be larger for the same `Engine displacement`. 
- What is the trend of mileage with `displ`?
As `displ` increases, mileage decreases up to about 5 liters. However, there are some mild increases in mileage between 5 to 7 liters of engine displacement. 

...
It'll underestimate the mean and the sd since it filters any value greater than or equal to 0. 

- Is the sample representative of the population?
It's not representative of the population. 

- How are the bootstrap results affected?
the mean and sd estimates are much less than the actual parameters. 

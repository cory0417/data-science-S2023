...
'cut', 'color', and 'clarity' variables are ordinals that have a specified order to their categorical values. 
...
- Diamonds with higher cut quality are more expensive.

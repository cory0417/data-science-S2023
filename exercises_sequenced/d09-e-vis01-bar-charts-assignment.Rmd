...
**Observations**:
- The value of visualized 'hwy' is the sum of all the 'hwy' outputs from the same 'cty' input value.
...
**Observations**:
- The bar chart shows the count of each class of vehicles with the color according its class.
...
**Observations**:
- The bar chart shows the count of each class of vehicles with the color and size of the the box within the bars that represent the 'drv' variable. 

**Compare `v1` and `v2`**:

- Which visualization---`v1` or `v2`---enabled you to make more observations?
'v2' enabled me to make more observations since it provided insight about the proportions of 'drv' as well within each class.
- What was the difference between `v1` and `v2`?
The difference between them was that the fill of the bars represented 'class' for 'v1' and 'drv' for 'v2'.
...
**Observations**
- The number of classes range between 1 to 4 for all the manufacturers. 
- There are quite a few manufacturers specializing in suv. 
- The count of vehicles in each class for each manufacturers are mostly below 10. 

...
The y-axis is ordered in an alphabetical order which makes is difficult to compare their sizes. 
...
- What are some issues with this graph?
Comparing the area of the circles are quite difficult to do without being in an order. 
...
- What are some issues with this graph?
The stacked bar chart makes it difficult to compare cut qualities other than ideal.
...
- What are some issues with this graph?
Using the area is not every helpful is visualizing simplet set of numbers. 

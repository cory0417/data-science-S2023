...
specific function?
You can put a '?' in front of the function or use help().
...
'cut_number' comes from 'ggplot2' package. 'parse_number' comes from 'readr' package. 'row_number' comes from 'dplyr' package. 

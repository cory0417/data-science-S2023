...
-   Is the bolded response **active** or **passive**? Why?\
    It's active because the presenter addresses directly to the colleague's question.
-   Is the bolded response **constructive** or **destructive**? Why?\
    It's constructive because the presenter admits the mistake and even credits the colleague.
-   How does this statement make you *feel*, relative to the bolded statement before the q1 prompt?\
    It creates a much safer environment for quality discussions.
...
-   Is the bolded response **active** or **passive**? Why?\
    It's passive because the presenter does nothing to build upon the colleague's comment.
-   Is the bolded response **constructive** or **destructive**? Why?\
    It's constructive since it conveys positive emotions.
-   How does this statement make you *feel*, relative to the bolded statement before the q1 prompt?\
    It doesn't hurt my emotions but feels unprofessional to leave the issue as is. 
...
-   Is the bolded response **active** or **passive**? Why?\
    It's passive since it doesn't have anything to do with the presenter's previous dialogue. 
-   Is the bolded response **constructive** or **destructive**? Why?\
    It could be either but generally asking a completely tangential question during a presentation is considered rude and thus, destructive. 

...
The 'suv' class has the highest count for a single 'cty' value. But it's not clear just from the plot which class has the most vehicles. 
...
'vis1' was more helpful for the count but 'vis2' for the distribution. 
...
**Observations**
- The bigger peaks and lower bottoms are still somewhat visible when the bin width is increased.
- The details in the pattern of the histogram gets progressively blurrier as the bin width is increased. 

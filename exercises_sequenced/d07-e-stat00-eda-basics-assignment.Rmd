...
**Observations**:
- Contrary to the hypothesis, number of 'Ideal' cut diamonds is greater than diamonds of any other cut types. 
...
**Observations**:
- It's not an effective graph because the size of the carat can also influence the price and the prices are too spread out.
...
**Observations**:
- It doesn't support the hypothesis since the median and the quartiles are not higher than all the other cuts, and the outliers are similarly spread out in comparison to other cuts as well. 
...
**Observations**:
- It partially supports the hypothesis because the median and quartile are the lowest for 'Ideal' and the outliers are also mostly below 3 carats. But we still can't say for sure to what extent the cut and the carat affect the price. 

...
That it maps out a single y value for a x value. 

- How does the `mpg` dataset violate this assumption?
There are multiple y values for a single x value.
...
It's easy to tell big historic events that impacted the unemployment.

- What can you tell based on the `Smoothed` data?
It's generally increasing. 
